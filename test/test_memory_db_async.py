...
'''
        ...
        # model
        model_test_build_myself_memory_two_expected = '''import uuid
...
class SampleTableTwoCreateOneResponseModel(BaseModel):
    ...
    class Config:
        ...
        model_test_build_myself_memory_expected = '''import uuid
from dataclasses import dataclass
from datetime import datetime, timedelta, date, time
from decimal import Decimal
from typing import Optional, List, Union, NewType
...
class SampleTableCreateOneResponseModel(BaseModel):
    ...
    class Config:
        ...
        # route
        route_test_build_myself_memory_two_expected = '''import copy
...
from fastapi_quick_crud_template.model.test_build_myself_memory_two import ( SampleTableTwoFindOneResponseModel, 
...
from fastapi_quick_crud_template.model.test_build_myself_memory_two import ( SampleTableTwoFindManyResponseModel, 
...
from fastapi_quick_crud_template.common.http_exception import UnknownOrderType, UnknownColumn
from fastapi_quickcrud_codegen.misc.type import Ordering
from fastapi_quick_crud_template.model.test_build_myself_memory_two import ( SampleTableTwoCreateOneResponseModel, 
...
def insert_one(response: Response,
    ...
    return result'''
        ...
        model_test_build_myself_memory_expected = '''import copy
from http import HTTPStatus
from typing import List, Union
from os import path
...
from fastapi_quick_crud_template.model.test_build_myself_memory import ( SampleTableFindOneResponseModel, 
...
from fastapi_quick_crud_template.common.http_exception import UnknownOrderType, UnknownColumn
from fastapi_quickcrud_codegen.misc.type import Ordering
from fastapi_quick_crud_template.model.test_build_myself_memory import ( SampleTableFindManyResponseModel, 
...
from fastapi_quick_crud_template.common.http_exception import UnknownOrderType, UnknownColumn
from fastapi_quickcrud_codegen.misc.type import Ordering
from fastapi_quick_crud_template.model.test_build_myself_memory import ( SampleTableCreateOneResponseModel, 
