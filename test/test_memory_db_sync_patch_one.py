...
class Testing(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        crud_router_builder(
            ...
            crud_methods=[CrudMethods.FIND_ONE, CrudMethods.FIND_MANY, CrudMethods.CREATE_ONE, CrudMethods.UPDATE_ONE, CrudMethods.PATCH_ONE],
            is_async=is_async,
