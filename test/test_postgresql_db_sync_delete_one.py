...
class Testing(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        model_list = [DbModel(db_model=SampleTable, prefix="/my_first_api", tags=["sample api"],
                              exclude_columns=['bytea_value'], crud_methods=[CrudMethods.DELETE_ONE]),
...
from model.test_build_myself_two import SampleTableTwo, SampleTableTwoDeleteOneRequestQueryModel, SampleTableTwoDeleteOneResponseModel, SampleTableTwoPrimaryKeyModel
...
from common.sql_session import db_session
from pydantic import parse_obj_as
from model.test_build_myself import SampleTable, SampleTableDeleteOneRequestQueryModel, SampleTableDeleteOneResponseModel, SampleTablePrimaryKeyModel
